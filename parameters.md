...
libraries_frameworks: eosio-cpp; Vite React in src/
coding_style_conventions: ups.hpp + invitono.cpp; NEVER TypeScript on-chain
...
architecture_directive: Product A = flexloans; Product B = easyloan; no balance-sync update()
