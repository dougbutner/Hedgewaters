...
inputs: Collateral/HEDGE transfers + borrower/SP/liq/redeem (A); EASY loan flows (B); flash borrow/callback/repay (C)
outputs: HEDGE issue/retire; Alcor out-tokens (B); flash fees to reserves (C); WASM/ABI
